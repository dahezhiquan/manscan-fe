export function iconPath(name) {
  const icons = {
    ...
    domain: `
      ...
      <path d="M4.2 12h15.6"/>
      <path d="M12 3.8c2.2 2.1 3.3 4.8 3.3 8.2s-1.1 6.1-3.3 8.2"/>
      <path d="M12 3.8C9.8 5.9 8.7 8.6 8.7 12s1.1 6.1 3.3 8.2"/>
      <path d="M6.2 6.6c1.5 1 3.4 1.5 5.8 1.5s4.3-.5 5.8-1.5"/>
      <path d="M6.2 17.4c1.5-1 3.4-1.5 5.8-1.5s4.3.5 5.8 1.5"/>
    `,
    server: `
